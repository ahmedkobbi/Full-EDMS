...
export default defineConfig({
  ...
  resolve: {
    alias: {
      ...
      '@smart-edms/tour-core': path.resolve(__dirname, '../../packages/tour-core/src/index.ts'),
      '@smart-edms/ai-core': path.resolve(__dirname, '../../packages/ai-core/src/index.ts'),
      '@smart-edms/utils': path.resolve(__dirname, '../../packages/utils/src/index.ts'),
      '@smart-edms/config': path.resolve(__dirname, '../../packages/config/src/index.ts'),
