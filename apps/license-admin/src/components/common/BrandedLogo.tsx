 ...
 * and login page. The wordmark "Smart EDMS" is the SAME in every locale
 * (the product name is never translated; only descriptive text translates).
 *
 * Mirrors the Electron client's BrandedLogo so the panel and the desktop
 * app are visually identical.
 */
