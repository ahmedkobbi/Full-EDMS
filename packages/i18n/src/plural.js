...
exports.pickPlural = pickPlural;
exports.formatPlural = formatPlural;
exports.pluralCategoriesFor = pluralCategoriesFor;
exports.buildCountMessage = buildCountMessage;
 ...
 */
function formatMessage(template, locale, variables = {}) {
    const intlLocale = (0, format_js_1.toIntlLocale)(locale);
    const formatter = new intl_messageformat_1.default(template, intlLocale);
 ...
 */
function pickPlural(message, locale, count) {
    const intlLocale = (0, format_js_1.toIntlLocale)(locale);
 ...
 *   );
 */
function formatPlural(message, locale, variables) {
 ...
 */
function buildCountMessage(one, other) {
