...
exports.ROLES_BY_PERMISSION = exports.AI_TOOL_CATALOG = void 0;
 ...
 */
function isToolAuthorized(tool, roles, licensedModules) {
    if (tool.requiredLicenseModule &&
    ...
    const satisfyingRoles = exports.ROLES_BY_PERMISSION[tool.requiredPermission];
    if (!satisfyingRoles) {
