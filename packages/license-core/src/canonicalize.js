...
exports.CanonicalizationError = void 0;
...
exports.CanonicalizationError = CanonicalizationError;
/**
...
// ---------------------------------------------------------------------------
function serializeValue(value, path, seen) {
    ...
    if (typeof value === 'object') {
        ...
        if (Array.isArray(value)) {
            ...
            out = serializeObject(value, path, seen);
        }
        seen.delete(value);
        return out;
    }
...
function serializeObject(obj, path, seen) {
...
function serializeArray(arr, path, seen) {
    const parts = [];
