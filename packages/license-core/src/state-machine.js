...
exports.LICENSE_STATE_LABEL = exports.DEFAULT_HEARTBEAT_FAILURE_THRESHOLD = exports.DEFAULT_EXPIRING_SOON_WINDOW_DAYS = void 0;
exports.computeLicenseState = computeLicenseState;
exports.statePermitsRegularOps = statePermitsRegularOps;
exports.statePermitsAdminRemediation = statePermitsAdminRemediation;
/**
 * Default warning window (in days) for `expiring_soon`. Licenses within
 * this many days of expiry are flagged as `expiring_soon`.
 */
exports.DEFAULT_EXPIRING_SOON_WINDOW_DAYS = 30;
/**
 ...
 */
exports.DEFAULT_HEARTBEAT_FAILURE_THRESHOLD = 5;
/**
 ...
 */
function computeLicenseState(input, options = {}) {
    const expiringSoonWindowDays = options.expiringSoonWindowDays ?? exports.DEFAULT_EXPIRING_SOON_WINDOW_DAYS;
    const heartbeatFailureThreshold = options.heartbeatFailureThreshold ?? exports.DEFAULT_HEARTBEAT_FAILURE_THRESHOLD;
    // -----------------------------------------------------------------
    ...
    if (input.revoked)
        return 'invalid';
    if (!input.deviceMatch)
        return 'invalid';
    if (!input.environmentMatch)
        return 'invalid';
    // -----------------------------------------------------------------
    ...
    if (input.heartbeatFailures >= heartbeatFailureThreshold &&
    ...
    const extendedRemediationMs = input.extendedRemediationThresholdDays * 24 * 60 * 60 * 1000;
 ...
 * passed to `t()`).
 */
exports.LICENSE_STATE_LABEL = Object.freeze({
 ...
 */
function statePermitsRegularOps(state) {
 ...
 */
function statePermitsAdminRemediation(state) {
