...
exports.serializeSedmslic = serializeSedmslic;
exports.parseSedmslic = parseSedmslic;
exports.serializeSedmsreq = serializeSedmsreq;
exports.parseSedmsreq = parseSedmsreq;
exports.serializeSedmscrl = serializeSedmscrl;
exports.parseSedmscrl = parseSedmscrl;
// ---------------------------------------------------------------------------
// .sedmslic
// ---------------------------------------------------------------------------
/**
 ...
 */
function serializeSedmslic(artifact) {
 ...
 */
function parseSedmslic(content) {
 ...
 * readability.
 */
function serializeSedmsreq(req) {
 ...
 */
function parseSedmsreq(content) {
 ...
 */
function serializeSedmscrl(crl) {
 ...
 */
function parseSedmscrl(content) {
...
// Internal helpers
// ---------------------------------------------------------------------------
function assertShape(value, fn) {
    if (value == null || typeof value !== 'object') {
        throw new Error(`${fn}: input is not an object`);
    }
}
function parseJsonStrict(content, fn) {
    ...
    try {
        ...
        throw new Error(`${fn}: invalid JSON: ${e instanceof Error ? e.message : String(e)}`);
    }
}
